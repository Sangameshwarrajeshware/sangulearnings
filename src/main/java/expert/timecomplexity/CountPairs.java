...
public class CountPairs {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("Equal pairs 1: " + countNumberOfPairs2(values1) + " Expected: 49");

    int[] values2 = {1, 1, 1};
    System.out.println("Equal pairs 2: " + countNumberOfPairs2(values2) + " Expected: 3");
  }
